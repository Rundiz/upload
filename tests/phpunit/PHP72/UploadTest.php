...
class UploadTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testGetDefaultFileExtensionsMimeTypes()
    {
        ...
        $this->assertTrue(
            empty(\Rundiz\Upload\Tests\PHPUnitFunctions\Arrays::array_diff_assoc_recursive(
                array('txt' => array('text/plain')), $Upload->getDefaultFileExtensionsMimeTypes()
            ))
        );
